"""
like batched_inv, but this implementation runs the sparse matrix stuff in a set of separate processes
 to speed things up.
"""
...
def recompute_factors_bias_batched_mp(Y, S, lambda_reg, dtype='float32', batch_size=1,
                                      solve=batched_inv.solve_sequential, num_batch_build_processes=4):
